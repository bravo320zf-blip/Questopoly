...
const DUNGEON_DATA = {
    ...
    "Vampire Manor": {
        ...
        encounters: [
            ...
            // MINI BOSS: LICH
            {
                name: "Lich", hp: 18, str: 5, dex: 5, int: 8, img: "https://static.wixstatic.com/media/b16479_be14c673302e4b8e9f1c5e4f534c2185~mv2.png",
                minions: [{ name: "Skeleton", count: 2, hp: 8, str: 2, dex: 3, int: 1, img: "https://static.wixstatic.com/media/b16479_fd360b09d65942a0a7cc4e7e34756731~mv2.png" }]
            }
        ]
    },
    "Demon Gate": {
    ...
    "Wyvern Peak": {
        ...
        encounters: [
            ...
            // MINI BOSS: BANDIT LORD
            {
                name: "Bandit Lord", hp: 16, str: 6, dex: 7, int: 4, img: "https://static.wixstatic.com/media/b16479_ab4caa336f3644edae8d298d307228cd~mv2.png",
                minions: [{ name: "Bandit", count: 2, hp: 10, str: 3, dex: 3, int: 1, img: "https://static.wixstatic.com/media/b16479_b031efc88dfe49899f2e2b4f619c788e~mv2.jpg" }]
            }
        ]
    }
};
